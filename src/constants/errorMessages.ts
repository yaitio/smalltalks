...
export const ERROR_MESSAGES: Record<string, ErrorMessageConfig> = {
  MIC_PERMISSION_DENIED: {
    ...
    message: 'Please allow microphone access to start a conversation. You can change this in your browser settings.',
    action: 'Learn how',
  ...
  POOR_CONNECTION: {
    ...
    message: 'Your connection quality is poor. The conversation may be affected. Consider checking your internet connection.',
  },

  BROWSER_NOT_SUPPORTED: {
    title: 'Browser not supported',
    message: 'Your browser does not support the required features. Please use Chrome, Firefox, Safari, or Edge.',
  },
